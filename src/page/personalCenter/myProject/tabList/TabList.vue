            ...
            <div class="cont-box mt15">
                <div class="cont-left">
                    ...
                    <div class="cont-line cont-line3">
                        <label>发布时间</label>
                        <span v-if="item.releaseTimeDate">{{item.releaseTimeDate | moment}}</span>
                        <span v-if="!item.releaseTimeDate">未发布</span>
                    </div>
                </div>
...
export default {
    ...
    created() {
        ...
        // this.item.releaseTime = this.item.releaseTime ? this.item.releaseTime.toString("yyyy-MM-dd") : '';
