    ...
    <div class="regist-bg">
        <div class="regist-bg2">
            <div class="regist-cont">
                <div class="form-cont">
                    <h4 class="form-title">欢迎加入麦盟咨询</h4>
...
import { sendPhoneCode, register } from '@/serverApi/registLogin'
                ...
                if (valid) {
                    ...
                    register(params).then(response => {
                        if(response.code == '200'){
                            ...
                            this.$router.push({ name: 'steps-3', params: { type: this.$route.params.type }});
                        }else {
